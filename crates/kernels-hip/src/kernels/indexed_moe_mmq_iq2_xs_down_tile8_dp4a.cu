// indexed_moe_mmq_iq2_xs_down_tile8_dp4a — IQ2_XS MoE MMQ tile8 down.
...
void flambeau_indexed_moe_mmq_iq2_xs_down_tile8_dp4a_q8_1(
    const flambeau_block_iq2_xs* __restrict__ down_w,
        ...
        for (int sub = 0; sub < q8_per_super; ++sub) {
            ...
            if (row_ok) {
                ...
                for (int l = 0; l < 4; ++l) {
                    ...
                    const uint8_t sb = KSIGNS_IQ2XS[(q_u16 >> 9) & 0x7F];
