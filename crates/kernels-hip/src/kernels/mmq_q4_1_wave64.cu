...
void flambeau_mmq_q4_1_wave64_q8_1(
    ...
    // Q4_1 and Q8_1 both have 32-element blocks → blocks_per_row_x == blocks_per_col_y.
    ...
    for (int b = 0; b < blocks_per_row_x; ++b) {
        // Decode Q4_1 weight block for this thread's row.
        ...
        for (int c = 0; c < TILE_N; ++c) {
            ...
            // Fold d·d_y·sumi + m·y_s directly into persistent sum.
