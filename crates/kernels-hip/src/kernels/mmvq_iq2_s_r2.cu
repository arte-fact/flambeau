// mmvq_iq2_s_r2 — IQ2_S MMVQ, multi-row r2 (DPP half-warp reduce).
...
__device__ void mmvq_iq2_s_r2_q8_1_body(
...
extern "C" __global__ void flambeau_mmvq_iq2_s_r2_q8_1(
    const flambeau_block_iq2_s* __restrict__ x,
    const flambeau_block_q8_1* __restrict__ y,
    ...
    mmvq_iq2_s_r2_q8_1_body<float>(x, y, dst, n_rows, n_superblocks_per_row);
}

extern "C" __global__ void flambeau_mmvq_iq2_s_r2_q8_1_f16(
    const flambeau_block_iq2_s* __restrict__ x,
    const flambeau_block_q8_1* __restrict__ y,
    ...
    mmvq_iq2_s_r2_q8_1_body<fb_fp16_t>(x, y, dst, n_rows, n_superblocks_per_row);
}
