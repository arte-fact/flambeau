#!/usr/bin/env bash
# Kernel trace UD-Q3_K_XL decode on a single MI50 (pp, devices 0).
# Phase 3 diagnosis of the K-quant gap surfaced in Phase 1
# (UD-Q3_K_XL at 0.42x Q4_0). Reports top decode kernels by wall.
set -euo pipefail

OUTDIR="${1:-/tmp/trace_ud_q3_k_xl}"
MODEL=/artefact/models/Qwen3.6-27B-UD-Q3_K_XL.gguf
