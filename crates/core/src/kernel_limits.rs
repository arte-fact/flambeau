...
/// drops the tail and (pre-) triggered OOB LDS writes at the reduce
/// step.
...
/// Historical: parity regression on Qwen3.6-35B-A3B was
/// caused by this being hardcoded at 128 (pre-), silently discarding
