...
pub fn indexed_moe_mmq_q4_k_gate_only_tile8(
    reg: &OpsRegistry,
    stream: &HipStream,
    w_gate: DevicePtr,
    y: DevicePtr,
    ...
    let module = reg.expect_module("indexed_moe_mmq_q4_k_gate_only_tile8_dp4a")?;
    let kernel = module.kernel("flambeau_indexed_moe_mmq_q4_k_gate_only_tile8_dp4a_q8_1")?;
...
pub fn indexed_moe_mmq_q4_k_up_only_tile8(
    reg: &OpsRegistry,
    stream: &HipStream,
    w_up: DevicePtr,
    y: DevicePtr,
    ...
    let module = reg.expect_module("indexed_moe_mmq_q4_k_up_only_tile8_dp4a")?;
    let kernel = module.kernel("flambeau_indexed_moe_mmq_q4_k_up_only_tile8_dp4a_q8_1")?;
